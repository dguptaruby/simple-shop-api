...
RSpec.describe "/orders", type: :request do
  ...
  let(:valid_attributes) {
    {customer_name: 'john', shipping_address: 'san jose', order_total: 100, paid_at: DateTime.now}
  }
  ...
  let(:invalid_attributes) {
    {customer_name: '', shipping_address: 'san jose', order_total: 100, paid_at: DateTime.now}
  }
